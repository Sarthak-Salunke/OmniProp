...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Navbar />
      <Box sx={{ flexGrow: 1, backgroundColor: '#f8fafc', pt: 16, pb: 20 }}>
        <Container maxWidth="lg" sx={{ mt: 8 }}>
          <Paper elevation={0} sx={{ borderRadius: '2rem', overflow: 'hidden', border: '1px solid #e2e8f0', shadow: '0 20px 50px rgba(0,0,0,0.05)' }}>
            <Box sx={{ p: 6, backgroundColor: 'primary.main', color: 'white' }}>
              <Typography variant="h3" sx={{ fontWeight: 900, tracking: '-0.05em', mb: 1 }}>
                Welcome Back, {user?.name}!
              </Typography>
              <Typography variant="h6" sx={{ opacity: 0.8, fontWeight: 500 }}>
                Manage your saved property searches and profile
              </Typography>
            </Box>
