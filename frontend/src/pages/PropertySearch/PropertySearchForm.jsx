...
// Create custom theme with unified colors
const theme = createTheme({
  palette: {
    primary: {
      main: '#0f766e', // Teal 700 - matches unified theme
    },
    secondary: {
      main: '#10b981', // Emerald 500 - matches unified theme
    },
  },
  typography: {
    ...
    <ThemeProvider theme={theme}>
      <div className="min-h-screen flex flex-col">
        ...
        <Box
          sx={{
            ...backgroundStyle,
            pt: { xs: 14, md: 16 }, // Sit closer to the fixed navbar
            flexGrow: 1,
            display: 'flex',
          ...
          >
            ...
            >
              ...
              >
                ...
                <Box
                  sx={{
                    background: 'linear-gradient(45deg, #0f766e 30%, #10b981 90%)',
                    padding: 2,
                    color: 'white',
                  }}
                >
                  <div className="d-flex justify-content-between align-items-center">
                    <div>
                      <Typography variant="h4" sx={{ fontWeight: 900, display: 'flex', alignItems: 'center', mb: 1, letterSpacing: '-0.02em' }}>
                        <FaSearch className="me-3" style={{ fontSize: '1.2em' }} />
                        Property Search
                      </Typography>
                        ...
                        {activeStep < 4 ? (
                          <button
                            ...
                            style={{
                              ...
                              borderColor: '#0f766e',
                              boxShadow: '0 3px 5px 2px rgba(15, 118, 110, 0.3)'
                            }}
