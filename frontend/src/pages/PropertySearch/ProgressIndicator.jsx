        ...
        >
          <motion.div
            ...
            animate={{
              ...
              backgroundColor: '#0f766e' // Teal 700 - unified primary
            }}
            ...
            >
              <Box
                sx={{
                  ...
                  margin: '0 auto',
                  backgroundColor: step.number < activeStep ? '#10b981' :
                    step.number === activeStep ? '#0f766e' : '#fff',
                  border: '2px solid',
                  borderColor: step.number <= activeStep ?
                    step.number === activeStep ? '#0f766e' : '#10b981' : '#e0e0e0',
                  color: step.number <= activeStep ? '#fff' : '#757575',
                  transition: 'all 0.3s ease',
                  boxShadow: step.number === activeStep ? '0 0 0 4px rgba(15, 118, 110, 0.2)' : 'none',
                  fontSize: '1.2rem'
                }}
              >
